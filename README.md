...
```mermaid
mindmap
  root((html-semantic-mastery))
    README.md
    gitignore[".gitignore"]
    assignment-01
      assignment-01-README["README.md"]
      index.html
    assignment-02
    assignment-03
    etc["...(assignment-04 -> assignment-50)"]
